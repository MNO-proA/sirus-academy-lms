...
//       if (onProgressUpdate) {
//         onProgressUpdate({ progressValue: state.played });
//       }
//     }
...
function VideoPlayer({
  ...
  function handleProgress(state) {
    if (!seeking && isReady) {
      setPlayed(state.played);
      // Only call onComplete if video finishes and hasn't been marked as viewed yet
      if (state.played === 1 && onComplete && !isAlreadyViewed) {
        onComplete();
      }
    }
  }
