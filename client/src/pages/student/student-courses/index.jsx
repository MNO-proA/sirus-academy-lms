...
function StudentCoursesPage() {
  ...
  const handleNavigation = async (courseId) => {
    setIsGlobalLoading(true);
    await new Promise(resolve => setTimeout(resolve, 500)); 
    navigate(`/academy/course-progress/${courseId}`);
  };

  // const handleNavigation = async (courseId) => {
  //   setIsLoading(true);
  //   await new Promise(resolve => setTimeout(resolve, 100)); // Small delay to ensure loading state is visible
  //   navigate(`/academy/course-progress/${courseId}`);
  // };
  ...
  }, [location.pathname]); // Also reset when route changes
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="mb-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6"
      >
                  ...
                  <div className="relative group">
                    ...
                    <div className="absolute inset-0 bg-black bg-opacity-40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                      <Button
                        ...
                        onClick={() => handleNavigation(course?.courseId)}
                      >
