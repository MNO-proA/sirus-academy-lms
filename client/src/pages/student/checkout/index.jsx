...
// const PaymentFormWrapper = ({ courseDetails }) => {
...
//                       <p className="text-sm text-gray-500">{courseDetails?.instructorName}</p>
//                     </div>
//                   </div>
//                   <div className="border-t pt-4">
//                     <div className="flex justify-between">
//                       <span>Subtotal</span>
//                       <span>${courseDetails?.pricing}</span>
//                     </div>
...
//                 >
//                   <PaymentFormWrapper courseDetails={courseDetails} />
//                 </PaymentForm>
//               </CardContent>
//             </Card>
//           </div>
...
// import { PaymentForm, CreditCard, GooglePay, ApplePay } from 'react-square-web-payments-sdk';
// import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/ui/tabs';
// import { CreditCard as CreditCardIcon, Wallet, Shield, Clock } from 'lucide-react';
// import { AuthContext } from "@/context/auth-context";
// import { createPaymentService } from "@/services";
...
//               <CreditCard
//                 buttonProps={{
//                   className: "w-full bg-primary hover:bg-primary/90 text-white font-medium py-3 rounded-lg transition-all duration-200 hover:shadow-lg",
//                   onClick: (event) => {
//                     event.preventDefault(); 
//                     console.log("Payment initiated");
//                   },
...
//       animate="animate"
//       variants={fadeIn}
//       className="pt-20 min-h-screen bg-gradient-to-b from-gray-50 to-white py-12 px-4 sm:px-6 lg:px-8"
//     >
//       <div className="max-w-4xl mx-auto">
//         <motion.h1 
//           initial={{ opacity: 0, y: -20 }}
